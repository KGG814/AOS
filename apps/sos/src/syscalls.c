...
void handle_usleep(seL4_CPtr reply_cap) {
    ...
    //seL4_CPtr new_reply_cap = cspace_copy_cap(cur_cspace, cur_cspace, reply_cap, seL4_AllRights);
    //register_timer(usec, &wake_process, (void*)new_reply_cap);
